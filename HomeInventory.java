...
public class HomeInventory extends JFrame
{
    ...
    JButton exitButton = new JButton();// Frame
...
// frame constructor
        ...
        gridConstraints.gridy = 0;gridConstraints.insets = new Insets(10, 10, 0, 10);
        ...
        gridConstraints.insets = new Insets(10, 0, 0, 10);gridConstraints.anchor = GridBagConstraints.WEST;
        ...
        photoTextArea.setPreferredSize(new Dimension(350, 35));photoTextArea.setFont(new Font("Arial", Font.PLAIN, 12));
        ...
        gridConstraints = new GridBagConstraints();
        gridConstraints.gridx = 1;gridConstraints.gridy = 7;
        gridConstraints.gridwidth = 3;
...
// dividing line
            ...
            y += dy;
            g2D.drawString("Price: $" + HomeInventory.myInventory[i].purchasePrice + ", Suven Internship Purchased on: " + HomeInventory.myInventory[i].purchaseDate, (int) (pf.getImageableX() + 25), y);
            y += dy;
